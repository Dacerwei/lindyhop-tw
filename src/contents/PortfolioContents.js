const PORTFOLIO_CONTENT = [
    {
        ...
        chineseDescription: "走訪台北30個景點、超過一百位舞者、國內外數十家媒體報導、超過九十萬次的點閱，我們用 Swing Dance 搖擺舞，讓全世界看見台北的美",
    ...
    },
    {
        ...
        chineseDescription: "全台灣第一個 Solo Jazz 比賽，就在 Naughty Swing What the PA!",
    ...
    {
        ID: 2,
        src: 'https://firebasestorage.googleapis.com/v0/b/naughty-swing-official-website.appspot.com/o/portfolio%2Fportfolio_02_leejeans_mini.jpg?alt=media&token=17c1e343-34a3-4003-bf8c-731acd638cf8',
        width: 1024,
        height: 683,
        title: "Lee Jeans Commercial",
        chineseDescription: "迎接夏天的來臨，把水球準備好、野餐墊拿出來，該是一起來 Refresh The City 的時候了！",
        englishDescription: "Get ready with your water balloon and picnic blanket to embrace summer. It's time to Refresh The City!",
        aspectRatio: 1.5,
        youtubeVideoID: 'FtdVL6pA_Vk'
    },
    {
        ID: 3,
        ...
        chineseDescription: "不斷挑戰自我！這次我們與國際大師 Nathan Bugh 在 What The Pa 帶來精彩 Solo Jazz 演出。",
    ...
    },
    {
        ...
        chineseDescription: "跟著我們，透過 Swing 一起探索台北西門陽光燦爛的街道吧！",
    ...
    },
    {
        ...
        height: 225,
        title: 'La La Land',
        chineseDescription: "以電影 La La Land 為靈感，並獲得 Catch Play 與金馬影展的邀請，我們將歌舞劇深具感染力的歡樂，用搖擺舞的方式呈現給台灣觀眾！",
    ...
    {
        ID: 6,
        src: 'https://firebasestorage.googleapis.com/v0/b/naughty-swing-official-website.appspot.com/o/portfolio%2Fportfolio_06_thinkitoutloud.jpg?alt=media&token=10d92526-baad-48b2-be59-e622d263ca3b',
        width: 1440,
        height: 960,
        title: "Blues Fusion - Thinking Out Loud ",
        chineseDescription: "這次我們收起 Swing 的輕快彈跳，隨性加入 Fusion、Blues 來詮釋這 Ed Sheeran 這首膾炙人口的雙人 MV 經典",
        englishDescription: "This time, Let's put some blues and fusion together and enjoy the dance",
        aspectRatio: 1.5,
