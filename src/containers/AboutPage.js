...
import { Segment, Container, Tab, List } from 'semantic-ui-react'
...
const AboutPage = (props) => {
    return (
        <div className="page-wrapper">
            <Segment as="section" vertical padded='very'>
                <Container as="section">
                    <h1>Introduction | 舞團介紹</h1>
